		...
		<div id="carouselExampleCaptions" class="carousel" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/img/slaid1.png" class="d-block w-100" alt="...">
	...
	<div class="container">
		...
		<div class="trust__dlock d-flex justify-content-around align-items-center flex-wrap">
			<div class="text-center">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Vector.svg" alt="img">
				<p>
			...
			<div class="text-center trust__dlock_before">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Vector2.svg" alt="img">
				<p>
					Индивидуальный<br>
					подход к каждому<br>
					клиенту
			...
			<div class="text-center">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Vector3.svg" alt="img">
				<p>
...
<section class="consultation" id="consultation">
	<div class="container">
		...
		<div class="d-flex justify-content-center">
			...
			<?php echo do_shortcode('[contact-form-7 id="8" title="Без названия"]'); ?>
		</div>
	</div>
</section>
...
<section class="cosmetology" id="cosmetology">
	<div class="container">
		...
		<div class="d-flex justify-content-between cosmetology__offer">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Component 1.png" alt="img">
		...
		<div class="peelings d-flex justify-content-between">
			...
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Component2.png" alt="img">
		</div>
	</div>
</section>
...
<section class="massage" id="massage">
	<div class="massage__container">
		<div class="d-flex justify-content-between massage__offer">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/massach.png" alt="img ">
...
<section class="eyelashes" id="eyelashes">
	<div class="container desctop">
		<div class="d-flex justify-content-between">
			...
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/eyelashes.png" alt="eyelashes">
		</div>
	</div>
...
<div class="laboratory__wi">
	<section class="laboratory" id="laboratory">
		<div class="laboratory__img">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/photo2.png" alt="photo">
		</div>
		<div class="container">
			<h2>
					...
					<div class="reviews__slaid d-flex justify-content-around">
						<div class="reviews__slaid_div">
							<div class="reviews__slaid__head d-flex justify-content-between">
								<div class="d-flex">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Ellipse 7.png" alt="foto">
						...
						<div class="reviews__slaid_div">
							<div class="reviews__slaid__head d-flex justify-content-between">
								<div class="d-flex">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Ellipse 8.png" alt="foto">
									<div class="reviews__slaid__head__name">
										<p>
											Ольга Реуцкая
										</p>
								...
								<div>
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/instagram.svg" alt="vk">
								</div>	
							</div>
							<p class="reviews__text">
						...
						<div class="reviews__slaid_div">
							<div class="reviews__slaid__head d-flex justify-content-between">
								<div class="d-flex">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Ellipse 9.png" alt="foto">
									<div class="reviews__slaid__head__name">
										<p>
											Андрей Матков
										</p>
				...
				<div class="swiper-slide">
					<div class="reviews__slaid d-flex justify-content-around">
						<div class="reviews__slaid_div">
							<div class="reviews__slaid__head d-flex justify-content-between">
								<div class="d-flex">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Ellipse 7.png" alt="foto" class="ava">
									<div class="reviews__slaid__head__name">
										<p>
											Елена Валентинова
										</p>
								...
								<div>
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/instagram.svg" alt="instagram" class="social_slaid">
								</div>	
							</div>
							<p class="reviews__text">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
				...
				<div class="swiper-slide">
					<div class="reviews__slaid d-flex justify-content-around">
						<div class="reviews__slaid_div">
							<div class="reviews__slaid__head d-flex justify-content-between">
								<div class="d-flex">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Ellipse 8.png" alt="foto" class="ava">
									<div class="reviews__slaid__head__name">
										<p>
											Ольга Реуцкая
										</p>
								...
								<div>
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/vk (2) 1.png" alt="vk" class="social_slaid">
								</div>	
							</div>
							<p class="reviews__text">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat
				...
				<div class="payment__blok">
					<div class="payment">
						...
						<div class="d-flex justify-content-around align-items-center">
							<div class="text-center">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/koshelek.png" alt="">
								<p>
									Наличные
								</p>
							</div>
							<div class="text-center">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/Group311.png" alt="">
								<p>
									Карта
								</p>
							</div>
							<div class="text-center">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/logobar-paypass.png" alt="">
								<p>
									PayPass
								</p>
							</div>
						...
						<div class="d-flex justify-content-center align-items-center">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/kisspng-credit.png" alt="">
